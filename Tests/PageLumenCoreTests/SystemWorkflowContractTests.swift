...
final class SystemWorkflowContractTests: XCTestCase {
    ...
    func testPackagedCapabilitiesMatchCurrentTargets() {
        let packaged: Set<PageLumenSystemWorkflowContract.PackagedCapability> = [.finderOpenFile, .finderQuickAction, .shareExtension, .quickLookPreview, .quickLookThumbnail]
